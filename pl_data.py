...
FOLLOW_BATCH = ('rna_element', 'ligand_element', 'ligand_bond_type',)

class RNALigandData(Data):

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)

    @staticmethod
    def from_rna_ligand_dicts(rna_dict=None, ligand_dict=None, **kwargs):
        instance = RNALigandData(**kwargs)

        if rna_dict is not None:
            for key, item in rna_dict.items():
                instance['rna_' + key] = item
...
class RNALigandDataLoader(DataLoader):
